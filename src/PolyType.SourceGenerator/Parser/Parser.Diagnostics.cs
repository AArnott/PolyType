...
public sealed partial class Parser
{
    ...
    internal static DiagnosticDescriptor MissingDefaultValueAttribute { get; } = new DiagnosticDescriptor(
        ...
        messageFormat: "The member '{0}' on type '{1}' has an initializer but no DefaultValueAttribute. Consider adding [DefaultValue({2})] to make the default value explicit in the type shape.",
        category: "Usage",
        defaultSeverity: DiagnosticSeverity.Warning,
        isEnabledByDefault: true);
}
